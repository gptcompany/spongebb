...
liquidity = "spongebb_provider.router:router"
```
...
```python
# spongebb_provider/__init__.py
from openbb_core.provider.abstract.provider import Provider

from spongebb_provider.models.net_liquidity import NetLiquidityFetcher
from spongebb_provider.models.global_liquidity import GlobalLiquidityFetcher
from spongebb_provider.models.regime import RegimeFetcher
from spongebb_provider.models.stealth_qe import StealthQEFetcher
...
uv add --editable ./spongebb_provider

# Option B: Install as separate package
uv pip install -e ./spongebb_provider
...
openbb-api \
  --app /media/sam/1TB/spongebb/src/liquidity/api/server.py \
  --name app \
  --host 0.0.0.0 \
  --port 6900 \
  --reload
...
- Package Name → `spongebb_provider`
